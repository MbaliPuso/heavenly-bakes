                ...
                <Container>
                  <Row className="justify-content-center">
                    <Col lg={8}>
                      ...
                      <Button
                        href="/"
                        className="btn btn-primary btn-outline-warning rounded-pill py-3 px-5"
                      >
                        Read More
                      </Button>
                    </Col>
            ...
            <Carousel.Item>
              ...
              <Carousel.Caption className="d-md-block">
                <Container>
                  <Row className="justify-content-center">
                    <Col lg={8}>
                      <p className="text-warning text-uppercase fw-bold mb-2">
                        The Best Bakery
                      </p>
                      <h1 className="display-1 text-light mb-4 animated slideInDown">
                        We Bake With Passion
        ...
        <div className="container-xxl py-4">
          <div className="container">
            <div className="row g-4">
              ...
              >
                <div className="fact-item bg-light rounded text-center h-100 p-5">
                  <i className="fa fa-users fa-4x text-warning mb-4" />
        ...
        <div className="container-xxl bg-light my-6 py-6 pb-0">
          <div className="container">
            <div
              ...
              style={{ maxWidth: 500 }}
            >
              <p className="text-warning text-uppercase mb-2">
                Client's Review
              </p>
            ...
            <div
              className="bg-warning text-light rounded-top p-5 my-6 mb-0 wow fadeInUp"
              data-wow-delay="0.1s"
            >
              <div className="row align-items-center">
                ...
                <div className="col-md-6 text-md-end">
                  <div className="position-relative">
                    ...
                    <button
                      type="button"
                      className="btn btn-warning py-2 px-3 position-absolute top-0 end-0 mt-2 me-2"
                    >
                      SignUp
                    </button>
                  </div>
